// ecommerce-store\tailwind.config.js
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // إضافة ألوان gray و blue الأساسية عشان تختفي التحذيرات
        gray: {
          50: '#f9fafb',
          100: '#f3f4f6',
          200: '#e5e7eb',
      ...
      boxShadow: {
        ...
        'medium': '0 4px 20px -2px rgba(0, 0, 0, 0.08), 0 12px 30px -4px rgba(0, 0, 0, 0.04)',
        'hard': '0 8px 30px -4px rgba(0, 0, 0, 0.12), 0 20px 40px -8px rgba(0, 0, 0, 0.06)',
      ...
      backgroundImage: {
        ...
        'gradient-secondary': 'linear-gradient(135deg, #64748b, #1e293b)',
        'gradient-success': 'linear-gradient(135deg, #22c55e, #15803d)',
        'gradient-danger': 'linear-gradient(135deg, #ef4444, #991b1b)',
        'gradient-warning': 'linear-gradient(135deg, #f59e0b, #b45309)',
        'gradient-info': 'linear-gradient(135deg, #3b82f6, #1e3a8a)',
